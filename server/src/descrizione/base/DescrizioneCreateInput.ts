...
@InputType()
class DescrizioneCreateInput {
  @ApiProperty({
    required: false,
    type: () => CapitoloCreateNestedManyWithoutDescrizionesInput,
  })
  @ValidateNested()
  @Type(() => CapitoloCreateNestedManyWithoutDescrizionesInput)
  @IsOptional()
  @Field(() => CapitoloCreateNestedManyWithoutDescrizionesInput, {
    nullable: true,
  })
